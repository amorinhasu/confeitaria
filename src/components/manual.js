...
const manualPages = [
  {
    ...
    description: [
      ...
      '',
      '**Comece por aqui:**',
      '1. Confira se `TRIVIA_USER_ID` e `KAIKI_USER_ID` estão no `.env`.',
  ...
  },
  {
    ...
    description: [
      ...
      '4. Envie.',
      '5. Se quiser, envie uma imagem no canal quando o Momozin pedir.',
      '',
      '**Campos do modal:**',
      '• título',
      '• descrição',
  ...
  },
  {
    ...
    description: [
      ...
      '• `TRIVIA_USER_ID` e `KAIKI_USER_ID` definem quem é o casal.',
      '',
      '**Como usar melhor:**',
