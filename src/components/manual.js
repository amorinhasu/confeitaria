...
const manualPages = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      '**Sorteio pelo painel:**',
      'Depois de cadastrar alguns itens, use **Sortear qualquer**, **Sortear filme** ou **Sortear série** para receber uma recomendação nova do CineMomozin.',
      ...
      'O sorteio ignora itens que já foram recomendados antes. Assim, cada clique tenta sugerir algo ainda não consumido por vocês.',
      'Quando a busca de catálogo estiver ativa, a recomendação também tenta enriquecer o resultado com título, ano, sinopse, nota e capa. Se a busca falhar, o registro salvo no Momozin aparece normalmente.',
      '',
      '**Histórico e sorteio:**',
      '**Ver Histórico** mostra todos os registros salvos recentemente, inclusive os que já foram recomendados. Os botões de sorteio escolhem apenas entre itens ainda não recomendados que combinam com o tipo escolhido.',
      '',
      '**Onde fica registrado:**',
  ...
  },
  {
    ...
    description: [
      ...
      '• **Status / Ver tempo atual:** antes de iniciar, mostra se existe sessão aberta; durante o foco, mostra tema, quem iniciou, tempo efetivo, tempo pausado, tempo total e pausas.',
      '• **Ver progresso:** mostra o acumulado das sessões já finalizadas, como histórico de foco do casal.',
      'Antes de iniciar, o painel mostra só **Iniciar estudo**, **Ver progresso** e **Status**. Durante uma sessão aberta, ele mostra os controles de pausa, retomada, finalização, tempo atual e progresso.',
      '',
      '**Como finalizar:**',
      ...
      '`/estudo retomar`',
      '`/estudo finalizar`',
      'Pelo painel, também existem **Status/Ver tempo atual** para a sessão aberta e **Ver progresso** para o histórico acumulado.',
      '',
      '**Exemplo simples:**',
      'Tema: Programação JavaScript → estudar → Pausa para Água → Retomar → Finalizar estudo.',
      '',
      '**Dica rápida:** use **Status** antes de iniciar, **Ver Tempo Atual** durante a sessão e **Ver Progresso** quando quiser ver o histórico do casal.',
    ].join('\n'),
    actionRows: [
      [
