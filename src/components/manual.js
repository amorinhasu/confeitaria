...
const manualPages = [
  ...
  },
  {
    ...
    description: [
      ...
      '',
      '**Recomendação pelo painel:**',
      'Use **O que vamos assistir?** quando quiser uma sugestão nova para o casal.',
      'Essa sugestão vem da busca de catálogo e prioriza conteúdos em alta, populares e lançamentos recentes.',
      'A recomendação mostra título, sinopse, ano, nota e capa oficial quando essas informações estão disponíveis.',
      'Se a busca de catálogo não responder no momento, o Momozin avisa com uma mensagem amigável para tentar de novo depois.',
      '',
      '**Histórico e recomendação:**',
      '**Ver Histórico** mostra os registros salvos manualmente por vocês. **O que vamos assistir?** é separado do histórico e não depende dos itens cadastrados no Momozin.',
      '',
      '**Onde fica registrado:**',
  ...
  },
  {
    ...
    description: [
      ...
      '• **Ver tempo atual:** durante o foco, mostra tema, quem iniciou, tempo efetivo, tempo pausado, tempo total e pausas.',
      '• **Ver progresso:** mostra o acumulado das sessões já finalizadas, como histórico de foco do casal.',
      'Antes de iniciar, o painel fixo de Estudos mostra só **Iniciar estudo** e **Ver progresso**. Durante uma sessão aberta, ele mostra os controles de pausa, retomada, finalização, tempo atual e progresso.',
      '',
      '**Como finalizar:**',
      ...
      '',
      '**Onde fica registrado:**',
      'O canal **Estudos** mantém uma mensagem fixa do Momozin. Ela é editada a cada início, pausa, retomada e finalização para mostrar o estado real da sessão sem criar várias mensagens repetidas.',
      '',
      '**Comandos slash equivalentes:**',
      '`/estudo iniciar tema:`',
      '`/estudo pausar tipo:`',
      ...
      '',
      '**Dica rápida:** olhe a mensagem fixa do canal Estudos para saber o estado atual, use **Ver Tempo Atual** durante a sessão e **Ver Progresso** quando quiser ver o histórico do casal.',
    ].join('\n'),
    actionRows: [
      [
